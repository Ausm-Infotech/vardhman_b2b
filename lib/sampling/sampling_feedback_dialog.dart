...
class SamplingFeedbackDialog extends StatelessWidget {
  SamplingFeedbackDialog({super.key});

  final SamplingController samplingController = Get.find<SamplingController>();
          ...
          child: Column(
            children: <Widget>[
              HeaderView(
                ...
                title: Text(
                  'Feedback for ${samplingController.rxSelectedOrderHeaderLine.value!.orderNumber}',
                ...
                trailing: DefaultTextStyle(
                  ...
                  child: PrimaryButton(
                    ...
                    onPressed: samplingController
                            .rxOrderDetailFeedbackMap.values
                            .any((feedback) => feedback.reason.trim().isEmpty)
                        ? null
                        : samplingController.submitFeedback,
                  ),
                ),
              ),
              Expanded(
                child: DataTable2(
                  ...
                  rows: samplingController.rxOrderDetailFeedbackMap.entries.map(
                    (mapEntry) {
